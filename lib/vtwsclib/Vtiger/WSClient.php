...
{
	include_once(WP_HELPDESK_INTEGRATION_DIRECTORY.'lib/vtwsclib/Vtiger/Net/HTTP_Client.php');
	include_once(WP_HELPDESK_INTEGRATION_DIRECTORY.'lib/vtwsclib/Vtiger/WSVersion.php');
