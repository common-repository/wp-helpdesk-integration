...
class SkinnyControllerHelpDeskIntegration extends SkinnyBaseControllerHelpDeskIntegration
{
...
class CallSkinnyHelpDeskObj extends SkinnyControllerHelpDeskIntegration
{
    private static $_instance = null;
    public static function getInstance()
    {
        if( !is_object(self::$_instance) )  //or if( is_null(self::$_instance) ) or if( self::$_instance == null )
            self::$_instance = new SkinnyControllerCrm();
