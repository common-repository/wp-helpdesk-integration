...
class SkinnyBaseActions_HelpDeskIntegration {
   ...
   */
   public function call($module='default', $action='index', $request=array('GET'=>array(), 'POST'=>array())) {
      $moduleClass = SkinnyControllerHelpDeskIntegration::camelize($module) . 'Actions';

      $actionMethod = 'execute'.SkinnyControllerHelpDeskIntegration::camelize($action);
   ...
   */
   ...
   {
     SkinnyBaseControllerHelpDeskIntegration::setLayout($layout);
   }
