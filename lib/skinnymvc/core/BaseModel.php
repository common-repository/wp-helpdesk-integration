...
abstract class SkinnyBaseModel_HelpDeskIntegration {
                        ...
                        foreach($criteria['conditions'] As $condition) {
                            if(is_array($condition)) {
                                if (empty($condition['left'])) {
                                    throw new SkinnyException_HelpDeskIntegration('Missing left side of the condition.');
                                }
                                if (empty($condition['condition'])) {
                                    throw new SkinnyException_HelpDeskIntegration('Invalid condition.');
                                }
                                if (!isset($condition['right'])) {
                                    if (!in_array(strtoupper($condition['condition']), array('NOT NULL', 'IS NULL'))) {
                                        throw new SkinnyException_HelpDeskIntegration('Missing right side of the condition.');
                                    } else {
