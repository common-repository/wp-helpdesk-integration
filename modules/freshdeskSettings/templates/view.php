...
<input type="hidden" id="get_config" value="<?php echo esc_attr__($config_data) ?>" >
<input type="hidden" id="revert_old_crm_pro" value="freshdesk">
<form id="smack-salesforce-settings-form" action="<?php echo esc_url($_SERVER['REQUEST_URI']); ?>" method="post">
	...
	<div class="wp-common-crm-content" style="width: 100%;float: left;">
		...
		<br>
		<label id="inneroptions" style="font-weight:bold;">Freshdesk Settings :</label>
		<table  class="settings-table">
			<tr><td></td></tr>
			<tr>
				<td style='margin-top:7px;padding-left:40px;display:flex'>
		...
		<table style="float:right;">
			<tr>
				<td>
					...
					<input type="hidden" id="tickets_fields_tmp" name="tickets_fields_tmp" value="smack_whi_freshdesk_tickets_fields-tmp">
					<input type="hidden" id="contact_fields_tmp" name="contact_fields_tmp" value="smack_whi_freshdesk_contacts_fields-tmp">
					<p class='submit'>
